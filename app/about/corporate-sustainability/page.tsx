...
export default function CorporateSustainabilityPage() {
  ...
  const s = m.corporateSustainability
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              className="mb-12"
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">{s.contentTitle}</h2>
              <div className="w-16 h-1 bg-[#E94709] mt-4" />

              <div className="mt-8 text-6xl md:text-8xl font-bold text-gray-100 select-none">SUSTAINABILITY</div>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              >
                <div className="bg-white rounded-lg shadow-lg p-8 border-l-4 border-[#E94709]">
                  ...
                  <div className="space-y-4 text-gray-600 leading-relaxed">
                    {s.quoteParagraphs.map((p, i) => (
                      <p key={i}>{p}</p>
                    ))}
                  </div>

                  <div className="mt-8 pt-6 border-t">
                    <p className="text-gray-500 text-sm">{s.ceoCaption}</p>
                    <p className="text-xl font-serif italic text-gray-800 mt-2">{s.ceoName}</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="relative w-64 h-64 mx-auto rounded-full overflow-hidden shadow-xl">
                  <Image src={s.ceoImageUrl} alt="Leadership Vision" fill className="object-cover" />
                </div>
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('${s.bottomBackgroundUrl}')`,
        }}
      >
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-white max-w-2xl mx-auto">{s.bottomTitle}</h3>
          </motion.div>
        </div>
      </section>
    </>
